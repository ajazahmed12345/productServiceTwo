...
public class FakeStoreProductService implements ProductService{
    ...
    public GenericProductDto createProduct(GenericProductDto genericProductDto) {
        RestTemplate restTemplate = restTemplateBuilder.build();
        ResponseEntity<GenericProductDto> response = restTemplate.postForEntity(productRequestsBaseUrl, genericProductDto, GenericProductDto.class);
...
//        genericProductDto.setId(id);
        ...
        return convertFakeStoreProductDtoToGenericProductDto(getResponse.getBody());
//        return convertFakeStoreProductDtoToGenericProductDto(response.getBody());
    }
}
